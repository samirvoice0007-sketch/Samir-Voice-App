window.I18N = {
  bn: {
    ...
    googleUnavailable: "Google লগইন এখনও সেটআপ হয়নি",
    phoneUnavailable: "ফোন লগইন এখনও সেটআপ হয়নি",
    phoneRequired: "ফোন নম্বর দিন (+৮৮০…)",
    otpRequired: "OTP কোড দিন",
    home: "হোম",
    rooms: "রুম",
    wallet: "ওয়ালেট",
    profile: "প্রোফাইল",
  ...
  en: {
    ...
    phoneUnavailable: "Phone login is not configured yet",
    phoneRequired: "Enter a phone number (+880…)",
